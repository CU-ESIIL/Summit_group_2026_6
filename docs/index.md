...
![Team hero image](assets/globes.gif)
...
!!! note "How to replace the image above"
    ...
    [Open image folder for changing image](https://github.com/CU-ESIIL/Summit_group_2026_6/tree/main/docs/assets/){ .md-button target="_blank" rel="noopener" }
